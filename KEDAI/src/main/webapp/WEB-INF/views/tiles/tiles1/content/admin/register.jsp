...
<div class="mt-5 mr-3" style="border: 0px solid red; padding: 0 1%;">
		...
		<div class="col-10 row" id="empRegister">
			<div class="col-6 register" style="border: 0px solid blue;">
				<div style="position: relative;">
					...
					<button type="button" id="idcheck" style="position: absolute; bottom: 5px; left: 280px;">아이디 중복확인</button><br>
	                <span id="idCheckResult"></span>
				</div>
				<div class="mt-3">
					<h6>비밀번호&nbsp;<span class="star">*</span></h6>
					<input type="password" name="pwd" id="pwd" maxlength="15" class="requiredInfo" placeholder="영문자,숫자,특수기호가 혼합된 8~15 글자로 입력하세요." /><br>
	            </div>
	            <div class="mt-3">
				...
				<div class="mt-3">
					...
					<input type="text" name="jubun" id="jubun" maxlength="13" class="requiredInfo" placeholder="'-' 구분없이 입력하세요." />
				</div>
			...
			<div class="col-6 register" style="border: 0px solid blue; position: relative;">
				...
				<div class="mt-3" style="display: flex;">
					...
					<div>
						<h6>직급</h6>
						<select name="fk_job_code" style="width: 180px;">
