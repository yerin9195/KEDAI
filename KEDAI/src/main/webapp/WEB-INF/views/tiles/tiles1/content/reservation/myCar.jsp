...
<%
    ...
    // sessionScope에서 모바일 번호 가져오기
    String mobileNumber = (String) session.getAttribute("loginuser.mobile");
    
    // 모바일 번호에서 7184 부분 추출하기
    String extractedPart = "";
    if (mobileNumber != null && mobileNumber.length() >= 7) {
        extractedPart = mobileNumber.substring(3, 7);
    }
%>
<style type="text/css">
	.register input {
...
<div style="border: 0px solid red; padding: 1% 0;">
	<h3><span class="icon"><i class="fa-solid fa-seedling"></i></span>&nbsp;&nbsp;나의 차량 정보 등록<span style="font-size: 12pt; color: #e68c0e;">&nbsp;&nbsp;* 표시는 필수입력 사항입니다.</span></h3>
			...
			<div class="col-6 register" style="border: 0px solid blue;">
	            ...
	            <div class="mt-3">
					...
					<div style="display: flex;">
	                     ...
	                     <div>
	                         <input type="text" name="hp2" id="hp2" class="requiredInfo" size="6" maxlength="4" value="<%=mobileNumber %>" style="width: 93px; text-align: center;">
	                         &nbsp;&nbsp;<i class="fa-solid fa-minus"></i>&nbsp;&nbsp;
	                     </div>
	                     <div>
	                         <input type="text" name="hp3" id="hp3" class="requiredInfo" size="6" maxlength="4" value="${sessionScope.loginuser.mobile }" style="width: 93px; text-align: center;">
	                     </div>
