...
<div id="container">
    ...
    <div id="in-container">
        <div id="place" style="background-color:white; border: solid 0px red; margin: 3%;">
         <h2 style="font-weight: 300; text-align:center;">가능지역<br><span style="font-size:8pt; text-align: center;">버스 번호를 누르시면 경로가 표시됩니다.</span></h2>
         ...
         <div id="bus_no" class="row">
            ...
            <input type="button" class="busStyle col-4" name="bus_no" value="103번">
              ...
              <h3 style="font-weight: 300; text-align:center;">불가능 지역</h3>
              <div id="bus-route">
